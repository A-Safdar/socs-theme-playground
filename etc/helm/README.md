...
```
127.0.0.1 playground-local-web
127.0.0.1 playground-local-webgateway
127.0.0.1 playground-local-authserver
```
...
Now, you can browse the URL: `https://playground-local-web`
