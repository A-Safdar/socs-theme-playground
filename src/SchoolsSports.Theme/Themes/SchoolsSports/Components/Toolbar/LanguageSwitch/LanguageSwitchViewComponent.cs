...
public class LanguageSwitchViewComponent(ILanguageProvider languageProvider) : AbpViewComponent
{
    ...
    public virtual async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        return View("~/Themes/SchoolsSports/Components/Toolbar/LanguageSwitch/Default.cshtml", model);
    }
}
